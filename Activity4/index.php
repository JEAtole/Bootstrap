   ...
   <body>
      ...
      <div class="container">
         ...
         <form class="form-horizontal">
            ...
            <div class="form-group">
               <label for="password" class=" control-label col-md-2">Enter your Password</label>
               <div class="col-md-10">
                  <input type="text" class="form-control">
               </div>
            </div>
      ...
      <?php
         /*
            ...
            <nav class="navbar navbar-inverse"> //bg-black text-white
            <nav class="navbar navbar-inverse navbar-fixed-bottom"> //same as inverse but at the bottom
            <nav class="navbar navbar-inverse navbar-fixed-top"> //same as inverse but at the top
         */
      ?>
